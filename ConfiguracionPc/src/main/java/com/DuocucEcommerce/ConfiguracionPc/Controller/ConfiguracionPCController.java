...
public class ConfiguracionPCController {
    ...
    @GetMapping 
    public ResponseEntity<List<ConfiguracionPCResponseDTO>> listar() { 
    ...
    @GetMapping("/{id}") 
    public ResponseEntity<ConfiguracionPCResponseDTO> buscarPorId(@PathVariable Integer id) { 
    ...
    public ResponseEntity<List<ConfiguracionPCResponseDTO>> listarPorUsuario(@PathVariable Integer usuarioId) { 
        return ResponseEntity.ok(service.listarPorUsuario(usuarioId)); 
    }
    @Operation(summary = "Crear configuracion de PC", description = "Registra un nuevo recurso de configuracion de PC.")
    @PostMapping 
    public ResponseEntity<ConfiguracionPCResponseDTO> crear(@Valid @RequestBody ConfiguracionPCCreateDTO dto) {
    ...
    @PutMapping("/{id}") 
    public ResponseEntity<ConfiguracionPCResponseDTO> actualizar(@PathVariable Integer id, @Valid @RequestBody ConfiguracionPCUpdateDTO dto) { 
        return ResponseEntity.ok(service.actualizar(id, dto)); 
    }
    @Operation(summary = "Evaluar compatibilidad", description = "Evalua la compatibilidad de una configuracion de PC.")
    @PostMapping("/{id}/evaluar") 
    public ResponseEntity<ConfiguracionPCResponseDTO> evaluar(@PathVariable Integer id) { 
        return ResponseEntity.ok(service.evaluar(id)); 
    }
